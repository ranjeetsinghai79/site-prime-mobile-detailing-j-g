...
export function TreatmentMenuSection({ config }: Props) {
    ...
    >
      ...
      >
        ...
        <div ref={leftRef} style={{ position: "sticky", top: "6rem" }}>
          ...
          >
            Every treatment at {business.name} is performed by board-certified providers
            using only FDA-approved technology and medical-grade products.
          </p>
        ...
        {/* ── Right column: treatment menu list ── */}
        <div ref={itemsRef}>
      ...
      <style>{`
        @media (max-width: 768px) {
          ...
          .treatment-menu-grid > div:first-child {
...
function MenuRow({
  ...
  function handleMouseEnter() {
    ...
    gsap.to(el.querySelector(".row-num"), {
      color: "var(--brand-accent-light)",
      duration: 0.25,
    })
  }
